...
function emplace(map, key, handler) {
  ...
  if (!handler.insert)
    throw new Error(true ? formatProdErrorMessage(10) : "No insert provided for key not already in map");
      ...
      return (next) => (action) => {
        ...
        measureUtils.measureTime(() => {
          ...
          if (result.wasMutated) {
            throw new Error(true ? _formatProdErrorMessage(19) : `A state mutation was detected between dispatches, in the path '${result.path || ""}'.  This may cause incorrect behavior. (https://redux.js.org/style-guide/style-guide#do-not-mutate-state)`);
          }
        });
        ...
        measureUtils.measureTime(() => {
          ...
          tracker = track(state);
          if (result.wasMutated) {
            throw new Error(true ? _formatProdErrorMessage2(20) : `A state mutation was detected inside a dispatch, in the path: ${result.path || ""}. Take a look at the reducer(s) handling the action ${stringify2(action)}. (https://redux.js.org/style-guide/style-guide#do-not-mutate-state)`);
          }
        });
...
function executeReducerBuilderCallback(builderCallback) {
  ...
  const builder = {
    addCase(typeOrActionCreator, reducer) {
      if (false) {
        if (actionMatchers.length > 0) {
          throw new Error(true ? _formatProdErrorMessage(26) : "`builder.addCase` should only be called before calling `builder.addMatcher`");
        }
        if (defaultCaseReducer) {
          throw new Error(true ? _formatProdErrorMessage2(27) : "`builder.addCase` should only be called before calling `builder.addDefaultCase`");
        }
      }
    ...
    addMatcher(matcher, reducer) {
      if (false) {
        if (defaultCaseReducer) {
          throw new Error(true ? _formatProdErrorMessage5(30) : "`builder.addMatcher` should only be called before calling `builder.addDefaultCase`");
        }
      }
      actionMatchers.push({
        matcher,
    ...
    addDefaultCase(reducer) {
      if (false) {
        if (defaultCaseReducer) {
          throw new Error(true ? _formatProdErrorMessage6(31) : "`builder.addDefaultCase` can only be called once");
        }
      }
...
function createReducer(initialState, mapOrBuilderCallback) {
  if (false) {
    if (typeof mapOrBuilderCallback === "object") {
      throw new Error(true ? _formatProdErrorMessage(8) : "The object notation for `createReducer` has been removed. Please use the 'builder callback' notation instead: https://redux-toolkit.js.org/api/createReducer");
    }
  }
      ...
      if (caseReducer) {
        if (isDraft2(previousState)) {
          ...
          if (result === void 0) {
            ...
            throw new Error(true ? formatProdErrorMessage(9) : "A case reducer on a non-draftable value must not return undefined");
          }
          return result;
        } else {
    ...
    function buildReducer() {
      if (false) {
        if (typeof options.extraReducers === "object") {
          throw new Error(true ? _formatProdErrorMessage4(14) : "The object notation for `createSlice.extraReducers` has been removed. Please use the 'builder callback' notation instead: https://redux-toolkit.js.org/api/createSlice");
        }
      }
      ...
      function selectSlice(state) {
        ...
        if (typeof sliceState === "undefined") {
          if (injected) {
            ...
            throw new Error(true ? _formatProdErrorMessage5(15) : "selectSlice returned undefined for an uninjected slice reducer");
          }
        }
        return sliceState;
      }
  ...
  function wrapper(rootState, ...args) {
    ...
    if (typeof sliceState === "undefined") {
      if (injected) {
        ...
        throw new Error(true ? _formatProdErrorMessage6(16) : "selectState returned undefined for an uninjected slice reducer");
      }
    }
...
var assertFunction = (func, expected) => {
  if (typeof func !== "function") {
    throw new Error(true ? formatProdErrorMessage(32) : `${expected} is not a function`);
  }
};
var noop2 = () => {
};
