...
import React__default, { useContext, useRef, useCallback, useDebugValue } from 'react';
  ...
  const wrapWithConnect = WrappedComponent => {
    ...
    function ConnectFunction(props) {
      ...
      const ContextToUse = React.useMemo(() => {
        ...
        reactIs.isContextConsumer( /*#__PURE__*/React.createElement(propsContext.Consumer, null)) ? propsContext : Context;
...
export { Provider, ReactReduxContext, connect, createDispatchHook, createSelectorHook, createStoreHook, shallowEqual, useDispatch, useSelector, useStore };
