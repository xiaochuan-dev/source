...
// src/scheduler.production.min.js
var require_scheduler_production_min = __commonJS({
  "src/scheduler.production.min.js"(exports) {
    "use strict";
...
var require_react_dom_production_min = __commonJS({
  "src/react-dom.production.min.js"(exports) {
    var React = __require("react");
    var Scheduler = require_scheduler_production_min();
    ...
    function updateMemoComponent(current, workInProgress2, Component, nextProps, renderLanes2) {
      ...
      if (!hasScheduledUpdateOrContext) {
        ...
        if (compare(prevProps, nextProps) && current.ref === workInProgress2.ref) {
          return bailoutOnAlreadyFinishedWork(current, workInProgress2, renderLanes2);
        }
      }
      workInProgress2.flags |= PerformedWork;
    ...
    var updateHostText$1;
    {
      ...
      updateHostContainer = function(current, workInProgress2) {
      };
      updateHostComponent$1 = function(current, workInProgress2, type, newProps, rootContainerInstance) {
        const oldProps = current.memoizedProps;
      ...
      updateHostText$1 = function(current, workInProgress2, oldText, newText) {
        if (oldText !== newText) {
          markUpdate(workInProgress2);
        }
      };
...
export default require_react_dom_production_min();
/**
