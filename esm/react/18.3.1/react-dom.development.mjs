...
// src/react-dom.development.mjs
var react_dom_development_exports = {};
__export(react_dom_development_exports, {
...
import { __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, Children } from "react";

// src/scheduler.development.mjs
...
// src/scheduler.d.mjs
var unstable_yieldValue = void 0;
var unstable_setDisableYieldValue = void 0;
...
}, "warnValidStyle");
{
  ...
  camelize = /* @__PURE__ */ __name(function(string) {
    return string.replace(hyphenPattern, function(_, character) {
      return character.toUpperCase();
    });
  }, "camelize");
  warnHyphenatedStyleName = /* @__PURE__ */ __name(function(name) {
  ...
  warnBadVendoredStyleName = /* @__PURE__ */ __name(function(name) {
    if (warnedStyleNames.hasOwnProperty(name) && warnedStyleNames[name]) {
      return;
    }
    warnedStyleNames[name] = true;
  ...
  warnStyleValueWithSemicolon = /* @__PURE__ */ __name(function(name, value) {
  ...
  warnStyleValueIsNaN = /* @__PURE__ */ __name(function(name, value) {
  ...
  warnStyleValueIsInfinity = /* @__PURE__ */ __name(function(name, value) {
...
var unstable_yieldValue2 = unstable_yieldValue;
var unstable_setDisableYieldValue2 = unstable_setDisableYieldValue;
var rendererID = null;
...
}, "updatedAncestorInfo");
{
  ...
  isTagValidWithParent = /* @__PURE__ */ __name(function(tag, parentTag) {
    switch (parentTag) {
      case "select":
  ...
  findInvalidAncestorForTag = /* @__PURE__ */ __name(function(tag, ancestorInfo) {
    switch (tag) {
      case "address":
      case "article":
      case "aside":
...
{
  findStrictRoot = /* @__PURE__ */ __name(function(fiber) {
  ...
  setToSortedString = /* @__PURE__ */ __name(function(set2) {
    var array = [];
...
{
  warnInvalidContextAccess = /* @__PURE__ */ __name(function() {
    error("Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo().");
  }, "warnInvalidContextAccess");
  warnInvalidHookAccess = /* @__PURE__ */ __name(function() {
  ...
  };
  {
    ...
    HooksDispatcherOnMountInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
  ...
  };
  {
    ...
    HooksDispatcherOnMountWithHookTypesInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
      currentHookNameInDev = "useCacheRefresh";
      updateHookTypesDev();
      return mountRefresh();
    }, "useCacheRefresh");
  ...
  };
  {
    ...
    HooksDispatcherOnUpdateInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
      currentHookNameInDev = "useCacheRefresh";
      updateHookTypesDev();
  ...
  };
  {
    ...
    HooksDispatcherOnRerenderInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
      currentHookNameInDev = "useCacheRefresh";
      updateHookTypesDev();
      return updateRefresh();
    }, "useCacheRefresh");
  ...
  };
  {
    ...
    InvalidNestedHooksDispatcherOnMountInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
      currentHookNameInDev = "useCacheRefresh";
      mountHookTypesDev();
      return mountRefresh();
    }, "useCacheRefresh");
  ...
  };
  {
    ...
    InvalidNestedHooksDispatcherOnUpdateInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
      currentHookNameInDev = "useCacheRefresh";
      updateHookTypesDev();
      return updateRefresh();
    }, "useCacheRefresh");
  ...
  };
  {
    ...
    InvalidNestedHooksDispatcherOnRerenderInDEV.useCacheRefresh = /* @__PURE__ */ __name(function useCacheRefresh() {
      currentHookNameInDev = "useCacheRefresh";
      updateHookTypesDev();
      return updateRefresh();
    }, "useCacheRefresh");
...
function commitRootImpl(root2, recoverableErrors, transitions, renderPriorityLevel) {
  ...
  if ((finishedWork.subtreeFlags & PassiveMask) !== NoFlags || (finishedWork.flags & PassiveMask) !== NoFlags) {
    if (!rootDoesHavePassiveEffects) {
      ...
      scheduleCallback$2(NormalPriority2, function() {
        flushPassiveEffects();
        return null;
      });
    }
...
{
  copyWithDeleteImpl = /* @__PURE__ */ __name(function(obj, path, index2) {
    var key = path[index2];
  ...
  copyWithDelete = /* @__PURE__ */ __name(function(obj, path) {
    return copyWithDeleteImpl(obj, path, 0);
  }, "copyWithDelete");
  copyWithRenameImpl = /* @__PURE__ */ __name(function(obj, oldPath, newPath, index2) {
  ...
  copyWithRename = /* @__PURE__ */ __name(function(obj, oldPath, newPath) {
  ...
  copyWithSetImpl = /* @__PURE__ */ __name(function(obj, path, index2, value) {
  ...
  copyWithSet = /* @__PURE__ */ __name(function(obj, path, value) {
    return copyWithSetImpl(obj, path, 0, value);
  }, "copyWithSet");
  findHook = /* @__PURE__ */ __name(function(fiber, id) {
...
// src/react-dom.d.mjs
var react_dom_d_default = react_dom_development_exports;
export {
  Internals as __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  createPortal$1 as createPortal,
  createRoot$1 as createRoot,
  react_dom_d_default as default,
  findDOMNode,
