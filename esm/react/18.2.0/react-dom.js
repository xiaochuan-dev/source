...
var emptyRefsObject = new Component().refs;
...
function renderWithHooks(current, workInProgress2, Component2, props, secondArg, nextRenderLanes) {
  ...
  let children = Component2(props, secondArg);
...
function updateMemoComponent(current, workInProgress2, Component2, nextProps, renderLanes2) {
  if (current === null) {
    ...
    const child = createFiberFromTypeAndProps(Component2.type, null, nextProps, workInProgress2, workInProgress2.mode, renderLanes2);
...
function updateFunctionComponent(current, workInProgress2, Component2, nextProps, renderLanes2) {
  ...
  prepareToReadContext(workInProgress2, renderLanes2);
  {
    nextChildren = renderWithHooks(current, workInProgress2, Component2, nextProps, context, renderLanes2);
    hasId = checkDidRenderIdHook();
  }
  if (current !== null && !didReceiveUpdate) {
    bailoutHooks(current, workInProgress2, renderLanes2);
...
function updateClassComponent(current, workInProgress2, Component2, nextProps, renderLanes2) {
  ...
  if (instance === null) {
    ...
    shouldUpdate = updateClassInstance(current, workInProgress2, Component2, nextProps, renderLanes2);
  }
  const nextUnitOfWork = finishClassComponent(current, workInProgress2, Component2, shouldUpdate, hasContext, renderLanes2);
  return nextUnitOfWork;
}
__name(updateClassComponent, "updateClassComponent");
function finishClassComponent(current, workInProgress2, Component2, shouldUpdate, hasContext, renderLanes2) {
...
function mountLazyComponent(_current, workInProgress2, elementType, renderLanes2) {
  ...
  const payload = lazyComponent._payload;
  const init = lazyComponent._init;
  let Component2 = init(payload);
  workInProgress2.type = Component2;
  const resolvedTag = workInProgress2.tag = resolveLazyComponentTag(Component2);
  const resolvedProps = resolveDefaultProps(Component2, props);
  let child;
  switch (resolvedTag) {
    case FunctionComponent: {
  ...
  let hint = "";
  throw Error(formatProdErrorMessage(306, Component2, hint));
}
...
function mountIndeterminateComponent(_current, workInProgress2, Component2, renderLanes2) {
  ...
  let context;
  {
    const unmaskedContext = getUnmaskedContext(workInProgress2, Component2, false);
    context = getMaskedContext(workInProgress2, unmaskedContext);
  }
  prepareToReadContext(workInProgress2, renderLanes2);
  let value;
...
function beginWork(current, workInProgress2, renderLanes2) {
  ...
  switch (workInProgress2.tag) {
    ...
    case FunctionComponent: {
      ...
      const resolvedProps = workInProgress2.elementType === Component2 ? unresolvedProps : resolveDefaultProps(Component2, unresolvedProps);
      return updateFunctionComponent(current, workInProgress2, Component2, resolvedProps, renderLanes2);
    }
    case ClassComponent: {
      const Component2 = workInProgress2.type;
      const unresolvedProps = workInProgress2.pendingProps;
      const resolvedProps = workInProgress2.elementType === Component2 ? unresolvedProps : resolveDefaultProps(Component2, unresolvedProps);
      return updateClassComponent(current, workInProgress2, Component2, resolvedProps, renderLanes2);
    }
    case HostRoot:
    ...
    case IncompleteClassComponent: {
      ...
      const unresolvedProps = workInProgress2.pendingProps;
      const resolvedProps = workInProgress2.elementType === Component2 ? unresolvedProps : resolveDefaultProps(Component2, unresolvedProps);
      return mountIncompleteClassComponent(current, workInProgress2, Component2, resolvedProps, renderLanes2);
    }
    case SuspenseListComponent: {
      return updateSuspenseListComponent(current, workInProgress2, renderLanes2);
    }
