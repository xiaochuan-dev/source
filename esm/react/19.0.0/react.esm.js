...
const React = /*#__PURE__*/Object.defineProperty({
  __proto__: null,
  Children,
  Component,
  ...
  __COMPILER_RUNTIME: ReactCompilerRuntime,
  cache,
  cloneElement,
  createContext,
  createElement,
  ...
  memo,
  startTransition,
  unstable_Activity: REACT_OFFSCREEN_TYPE,
...
export { Children, Component, REACT_FRAGMENT_TYPE as Fragment, REACT_PROFILER_TYPE as Profiler, PureComponent, REACT_STRICT_MODE_TYPE as StrictMode, REACT_SUSPENSE_TYPE as Suspense, ReactSharedInternals as __CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ReactCompilerRuntime as __COMPILER_RUNTIME, cache, cloneElement, createContext, createElement, createRef, React as default, useEffectEvent as experimental_useEffectEvent, forwardRef, isValidElement, lazy, memo, startTransition, REACT_OFFSCREEN_TYPE as unstable_Activity, REACT_DEBUG_TRACING_MODE_TYPE as unstable_DebugTracingMode, REACT_LEGACY_HIDDEN_TYPE as unstable_LegacyHidden, REACT_SCOPE_TYPE as unstable_Scope, REACT_SUSPENSE_LIST_TYPE as unstable_SuspenseList, REACT_TRACING_MARKER_TYPE as unstable_TracingMarker, getCacheForType as unstable_getCacheForType, useCacheRefresh as unstable_useCacheRefresh, use, useActionState, useCallback, useContext, useDebugValue, useDeferredValue, useEffect, useId, useImperativeHandle, useInsertionEffect, useLayoutEffect, useMemo, useOptimistic, useReducer, useRef, useState, useSyncExternalStore, useTransition, ReactVersion as version };
