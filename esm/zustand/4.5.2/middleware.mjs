...
const devtoolsImpl = (fn, devtoolsOptions = {}) => (set, get, api) => {
  ...
  try {
    extensionConnector = (enabled ?? (import.meta.env ? import.meta.env.MODE : void 0) !== "production") && window.__REDUX_DEVTOOLS_EXTENSION__;
  } catch (e) {
  }
...
const oldImpl = (config, baseOptions) => (set, get, api) => {
  ...
  const hydrate = () => {
    ...
    const postRehydrationCallback = options.onRehydrateStorage?.(get()) || void 0;
