...
var prop_types = __webpack_require__(775);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
// EXTERNAL MODULE: external "ReactDOM"
var external_ReactDOM_ = __webpack_require__(845);
...
class DraggableCore extends external_React_.Component /*:: <DraggableCoreProps>*/{
  constructor() {
    super(...arguments);
  ...
  findDOMNode() /*: ?HTMLElement*/{
    ...
    return (_this$props = this.props) !== null && _this$props !== void 0 && _this$props.nodeRef ? (_this$props2 = this.props) === null || _this$props2 === void 0 || (_this$props2 = _this$props2.nodeRef) === null || _this$props2 === void 0 ? void 0 : _this$props2.current : external_ReactDOM_default().findDOMNode(this);
  }
  render() /*: React.Element<any>*/{
    // Reuse the child provided
    // This makes it flexible to use whatever element is wanted (div, ul, etc)
    return /*#__PURE__*/external_React_.cloneElement(external_React_.Children.only(this.props.children), {
...
class Draggable extends external_React_.Component /*:: <DraggableProps, DraggableState>*/{
  // React 16.3+
  // Arity (props, state)
  ...
  findDOMNode() /*: ?HTMLElement*/{
    ...
    return (_this$props$nodeRef$c = (_this$props = this.props) === null || _this$props === void 0 || (_this$props = _this$props.nodeRef) === null || _this$props === void 0 ? void 0 : _this$props.current) !== null && _this$props$nodeRef$c !== void 0 ? _this$props$nodeRef$c : external_ReactDOM_default().findDOMNode(this);
  }
  render() /*: ReactElement<any>*/{
    ...
    // Reuse the child provided
    // This makes it flexible to use whatever element is wanted (div, ul, etc)
    return /*#__PURE__*/external_React_.createElement(DraggableCore, _extends({}, draggableCoreProps, {
      onStart: this.onDragStart,
      onDrag: this.onDrag,
      onStop: this.onDragStop
    }), /*#__PURE__*/external_React_.cloneElement(external_React_.Children.only(children), {
      className: className,
      style: {
