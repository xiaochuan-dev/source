(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f():typeof define==='function'&&define.amd?define(f):(g=typeof globalThis!=='undefined'?globalThis:g||self,g.dayjs_plugin_localeData=f());})(this,(function(){'use strict';// eslint-disable-next-line import/prefer-default-export
const t = format =>
  format.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, (_, a, b) => a || b.slice(1));var index = (o, c, dayjs) => { // locale needed later
...
};return index;}));//# sourceMappingURL=localeData.js.map
