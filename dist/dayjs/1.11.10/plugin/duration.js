(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f():typeof define==='function'&&define.amd?define(f):(g=typeof globalThis!=='undefined'?globalThis:g||self,g.dayjs_plugin_duration=f());})(this,(function(){'use strict';const SECONDS_A_MINUTE = 60;
...
const REGEX_FORMAT = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;const MILLISECONDS_A_YEAR = MILLISECONDS_A_DAY * 365;
...
};return index;}));//# sourceMappingURL=duration.js.map
