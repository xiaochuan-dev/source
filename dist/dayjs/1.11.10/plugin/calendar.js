(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f():typeof define==='function'&&define.amd?define(f):(g=typeof globalThis!=='undefined'?globalThis:g||self,g.dayjs_plugin_calendar=f());})(this,(function(){'use strict';var index = (o, c, d) => {
  const LT = 'h:mm A';
  const L = 'MM/DD/YYYY';
...
};return index;}));//# sourceMappingURL=calendar.js.map
