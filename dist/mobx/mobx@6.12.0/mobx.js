(function (global, factory) {
    ...
    function collectStoredAnnotations(target) {
        if (!hasProp(target, storedAnnotationsSymbol)) {
            // if (false && !target[storedAnnotationsSymbol]) {
            //     die(
    ...
    function decorate_20223_$4(mthd, context) {
    ...
    function decorate_20223_$3(mthd, context) {
    ...
    function decorate_20223_$2(get, context) {
        const ann = this;
        ...
        addInitializer(function () {
            ...
            options.name ||= `ObservableObject.${key.toString()}`;
    ...
    function decorate_20223_$1(desc, context) {
        const ann = this;
        ...
        function initializeObservable(target, value) {
            ...
            const observable = new ObservableValue(value, ann.options_?.enhancer ?? deepEnhancer, `ObservableObject.${name.toString()}`, false);
    ...
    class ObservableValue extends Atom {
        ...
        value_;
        dehancer;
        constructor(value, enhancer, name_ = "ObservableValue", notifySpy = true, equals = comparer.default) {
            super(name_);
        ...
        runReaction_() {
            if (!this.isDisposed_) {
                ...
                if (shouldCompute(this)) {
                    ...
                    try {
                        this.onInvalidate_();
                        if (false && this.isTrackPending_ && isSpyEnabled()) ;
                    }
                    catch (e) {
    ...
    function _when(predicate, effect, opts) {
        ...
        opts.name = "When";
        const effectAction = createAction("When-effect", effect);
        // eslint-disable-next-line
    ...
    function makeObservable(target, annotations, options) {
        initObservable(() => {
            const adm = asObservableObject(target, options)[$mobx];
            if (false && annotations && target[storedAnnotationsSymbol]) ;
    ...
    class ObservableArrayAdministration {
        ...
        proxy_;
        lastKnownLength_ = 0;
        constructor(name = "ObservableArray", enhancer, owned_, legacyMode_) {
            this.owned_ = owned_;
    ...
    class ObservableObjectAdministration {
        ...
        defineObservableProperty_(key, value, enhancer, proxyTrap = false) {
            ...
            try {
                ...
                const observable = new ObservableValue(value, enhancer, false ? `${this.name_}.${key.toString()}` : "ObservableObject.key", false);
        ...
        delete_(key, proxyTrap = false) {
            ...
            try {
                startBatch();
                const notify = hasListeners(this);
                const notifySpy = false && isSpyEnabled();
                const observable = this.values_.get(key);
    ...
    class LegacyObservableArray extends StubArray {
        constructor(initialValues, enhancer, name = "ObservableArray", owned = false) {
            super();
            initObservable(() => {
