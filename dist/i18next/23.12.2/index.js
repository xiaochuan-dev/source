...
__webpack_require__.d(__webpack_exports__, {
  changeLanguage: () => (/* binding */ changeLanguage),
  createInstance: () => (/* binding */ createInstance),
  "default": () => (/* binding */ src),
  dir: () => (/* binding */ dir),
  exists: () => (/* binding */ exists),
  getFixedT: () => (/* binding */ getFixedT),
  hasLoadedNamespace: () => (/* binding */ hasLoadedNamespace),
  init: () => (/* binding */ init),
  loadLanguages: () => (/* binding */ loadLanguages),
  loadNamespaces: () => (/* binding */ loadNamespaces),
  loadResources: () => (/* binding */ loadResources),
  reloadResources: () => (/* binding */ reloadResources),
  setDefaultNamespace: () => (/* binding */ setDefaultNamespace),
  t: () => (/* binding */ t),
  use: () => (/* binding */ use)
});
...
;// CONCATENATED MODULE: ./src/ResourceStore.js


class ResourceStore extends src_EventEmitter {
  constructor(data) {
    let options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
      ns: ['translation'],
...
/* harmony default export */ const src_ResourceStore = (ResourceStore);
;// CONCATENATED MODULE: ./src/postProcessor.js
/* harmony default export */ const postProcessor = ({
  processors: {},
...
class Translator extends src_EventEmitter {
  constructor(services) {
    ...
    this.logger = logger.create('translator');
  }
  changeLanguage(lng) {
...
/* harmony default export */ const src_Translator = (Translator);
;// CONCATENATED MODULE: ./src/LanguageUtils.js
...
;// CONCATENATED MODULE: ./src/PluralResolver.js
...
/* harmony default export */ const src_PluralResolver = (PluralResolver);
;// CONCATENATED MODULE: ./src/Interpolator.js
...
class Interpolator {
  ...
  init() {
    ...
    this.escape = escape !== undefined ? escape : utils_escape;
  ...
  nest(str, fc) {
    ...
    while (match = this.nestingRegexp.exec(str)) {
      ...
      if (doReduce) {
        ...
        (v, f) => this.format(v, f, options.lng, {
          ...options,
...
/* harmony default export */ const src_Interpolator = (Interpolator);
;// CONCATENATED MODULE: ./src/Formatter.js
    ...
    if (formatName === 'currency' && optStr.indexOf(':') < 0) {
      ...
      opts.forEach(opt => {
        if (opt) {
          ...
          const val = rest.join(':').trim().replace(/^'+|'+$/g, ''); // trim and replace ''
...
class Formatter {
  constructor() {
    let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    this.logger = logger.create('formatter');
    this.options = options;
    this.formats = {
...
/* harmony default export */ const src_Formatter = (Formatter);
;// CONCATENATED MODULE: ./src/BackendConnector.js
...
class Connector extends src_EventEmitter {
  constructor(backend, store, services) {
    ...
    this.options = options;
    this.logger = logger.create('backendConnector');
    this.waitingReads = [];
...
/* harmony default export */ const BackendConnector = (Connector);
...
;// CONCATENATED MODULE: ./src/i18next.js
...
class I18n extends src_EventEmitter {
  constructor() {
    let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      this.store = new src_ResourceStore(this.options.resources, this.options);
      const s = this.services;
      s.logger = logger;
      s.resourceStore = this.store;
      s.languageUtils = lu;
      s.pluralResolver = new src_PluralResolver(lu, {
      ...
      s.interpolator = new src_Interpolator(this.options);
      s.utils = {
      ...
      this.translator = new src_Translator(this.services, this.options);
  ...
  dir(lng) {
    ...
    const languageUtils = this.services && this.services.languageUtils || new LanguageUtils(get()); // for uninitialized usage
  ...
  cloneInstance() {
    ...
    if (forkResourceStore) {
      clone.store = new src_ResourceStore(this.store.data, mergedOptions);
      clone.services.resourceStore = clone.store;
    }
    clone.translator = new src_Translator(clone.services, mergedOptions);
...
/* harmony default export */ const src = (i18next);
const createInstance = i18next.createInstance;
const dir = i18next.dir;
const init = i18next.init;
const loadResources = i18next.loadResources;
const reloadResources = i18next.reloadResources;
const use = i18next.use;
const changeLanguage = i18next.changeLanguage;
const getFixedT = i18next.getFixedT;
const t = i18next.t;
const exists = i18next.exists;
const setDefaultNamespace = i18next.setDefaultNamespace;
const hasLoadedNamespace = i18next.hasLoadedNamespace;
const loadNamespaces = i18next.loadNamespaces;
const loadLanguages = i18next.loadLanguages;
