(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('single-spa')) :
	typeof define === 'function' && define.amd ? define(['exports', 'single-spa'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.qiankun = {}, global.singleSpa));
}(this, (function (exports, singleSpa) { 'use strict';
	...
	function patchLooseSandbox(appName, appWrapperGetter, sandbox) {
	   ...
	   */
	  function () {
	    return singleSpa.checkActivityFunctions(window.location).some(function (name) {
	      return name === appName;
	    });
	  }, function () {
	    return {
	...
	function prefetchAfterFirstMounted(apps, opts) {
	  window.addEventListener('single-spa:first-mount', function listener() {
	    var notLoadedApps = apps.filter(function (app) {
	      return singleSpa.getAppStatus(app.name) === singleSpa.NOT_LOADED;
	    });
	    {
	...
	function loadMicroApp(app, configuration, lifeCycles) {
	  ...
	  microApp = singleSpa.mountRootParcel(memorizedLoadingFn, _objectSpread({
